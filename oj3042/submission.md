...
```text
Task assign me to do temp calculator (from 4 difference unit : C K R F )
...
Output:
Result of Temperature after change
```
...
```text
Step 1: recieve input and change to C base
Step 2: Calculate to final Temperature base and return them
```
...
```text
same as i think (don't need to implement)
```
