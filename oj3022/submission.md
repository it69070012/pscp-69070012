...
```text
Task assign me make temperature converter from 4 difference unit (C K R F)
...
```text
Step 1: recieve temperature and convert to base (C)
Step 2: Convert to final unit and return them
```
